...
#=============
cl = LineClient("adanncuy@gmail.com","Sayang001")
...
ki = LineClient("mr.bertard@gmail.com","ardira18")
...
kk = LineClient("ncuygaming1992@gmail.com","Sayang001")
...
kc = LineClient("sellyviana1992@gmail.com","Sayang001")
...
km = LineClient("adandratieons@gmail.com","Sayang001")
...
kb = LineClient("adangren95@gmail.com","Sayang001")
...
kn = LineClient("adangren1992@gmail.com","Sayang001")
...
ko = LineClient("putribunga533@gmail.com","putribunga03")
...
kw = LineClient("raeldyeliano.f@gmail.com","Raeldy10")
...
ke = LineClient("alpianwakwaw22@gmail.com","Sayang001")
...
ky = LineClient("cintadustancuy","Sayang001")
...
sw = LineClient("botncuy1992","Sayang001")
...
staff = ["u3a3d2af88f1113cd00e7934f862af688"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
...
def bot(op):
    ...
    try:
        ...
        if op.type == 5:
            print ("[ 5 ] SELFBOT-BY:AdanNcuy AUTO BLOCK")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for group in saya:
                                   cl.sendMessage(group,"[ SELFBOT-BY:AdanNcuy ]\n" + str(pesan))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"SELFBOT-BY:AdanNcuy\n\n"+ma+"\nTotal「%s」 Bots" %(str(len(Bots))))
                          ...
                          if msg._from in admin:
                           if msg.toType == 2:
                            ...
                            if msg._from in admin:
                                ...
                                targets.remove(mid)
                                if targets == []:
                                    cl.sendText(msg.to,"AdanNcuy KICK OUT BYE")
                                else:
                                    for target in targets:
                                      if target not in Bots:
                                        try:
